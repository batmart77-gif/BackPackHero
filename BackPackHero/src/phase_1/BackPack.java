...
public class BackPack {
     ...
     */
    public void addGold(int amount) { // < 5 lignes
        if (amount < 0) {
     ...
     */
    public int getGoldQuantity() { // < 5 lignes
	...
	public boolean contains(ItemInstance itemInstance) {
        Objects.requireNonNull(itemInstance, "ItemInstance cannot be null.");
        return this.backpack.containsKey(itemInstance);
    }
