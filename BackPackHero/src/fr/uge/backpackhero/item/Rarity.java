...
/**
 * Represents the rarity level of an item, influencing its value, power,
 * and appearance frequency in the game.
 *
...
public enum Rarity {
	...
	/** * Special rarity reserved for Malice or negative effects.
     * These items are often unwanted and carry penalties.
     */
	CURSE
}
