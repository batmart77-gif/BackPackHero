...
/**
 * Represents a curse item. 
 * A curse usually occupies space in the backpack but provides no benefit 
 * and cannot be meaningfully used in combat.
 */
public record Curse(List<Position> pos) implements Item {
	...
	/**
     * Curses cannot be used in combat and have no effect.
     *
