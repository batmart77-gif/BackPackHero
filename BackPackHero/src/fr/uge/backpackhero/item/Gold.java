 ...
 * Gold occupies one slot in the backpack but cannot be used in combat.
 */
public record Gold() implements Item {
    
	/**
     * Constructs a Gold item.
     * No parameters are required since gold always occupies a single tile.
     */
	public Gold {
	}
